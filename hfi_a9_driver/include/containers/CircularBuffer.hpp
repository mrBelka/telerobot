    ...
    public:
        ...
        T pop()
        {
            if (m_next_read == m_next_write)
                throw std::out_of_range("pop: CircularBuffer is empty");
        ...
        {
            if (m_next_read == m_next_write)
                throw std::out_of_range("peek: CircularBuffer is empty");
